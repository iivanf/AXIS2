...
/**
 *  GetConversion bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetConversion implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getConversion", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getConversion", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetConversion parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetConversion object = new GetConversion();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getConversion".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetConversion) conversor.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
